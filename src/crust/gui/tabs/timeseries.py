...
windows (`crust.gui.site_tree`; 2 h at 1000 Hz, 4 h at 500 Hz, see
`crust.gui.windows`). Clicking a window makes it `State.selection`, which
...
magnetics blue and electrics red (`crust.gui.theme`), or the recorder's own
names such as Bx By Bz E1 E2 E3 E4 on a LEMI-424 (`crust.gui.channels`),
...
from crust.gui.plots import clear_layout, follow_visible_y, stack_plots
from crust.gui.site_tree import SITE_ROLE, SiteTree
