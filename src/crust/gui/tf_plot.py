...
ticks and spines come from the rcParams `crust.gui.theme.apply` sets before
...
A MANTLE product carries typed verdicts (`crust.gui.mantle_products`).
...
from crust.gui import mantle_products, theme
