...
from crust.survey import CHANNEL_PRESETS, INSTRUMENTS as SURVEY_INSTRUMENTS, SITE_TABLE_COLUMNS, default_preset
from crust.gui.channels_column import UNCHANGED
from crust.gui.theme import DISABLED
...
class NewSurveyDialog(QDialog):
    ...
    the instrument's presets (`crust.survey.CHANNEL_PRESETS`, its default
