...
(`crust.survey.CHANNEL_PRESETS`) once in `defaults: channels:`; a site that
...
(`crust.survey.preset_label`, e.g. "Ex Ey Bx By"), or the list itself when it
...
from crust.survey import CHANNEL_PRESETS, channels_from_label, preset_label
