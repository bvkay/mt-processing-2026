"""Desktop GUI for the BBMT processing workflow (PySide6 + pyqtgraph).
...
`src/bbmt/` and is reached through a script in `scripts/`.

Run it with::

    python -m bbmt_gui [surveys/<name>/survey.yaml]
"""
